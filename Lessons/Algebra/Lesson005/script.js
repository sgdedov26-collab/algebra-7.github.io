...
const slidesData = [
    ...
    // Слайд 5 - Интерактивное задание: Приведение подобных
    {
        title: "Интерактивное задание: Приведение подобных",
        content: `
            <div class="exercise">
                <h3><i class="fas fa-compress-arrows-alt"></i> Приведение подобных членов многочлена</h3>
                
                <div class="interactive-task">
                    <p>Дан «неприведенный» многочлен \\(3x^2 + 5y - 2x + 4 - x^2 + 7\\).</p>
                    <p>Выполните два шага:</p>
                    <ol>
                        <li>Найдите и объедините подобные члены</li>
                        <li>Расположите члены в порядке убывания степени</li>
                    </ol>
                    
                    <div class="polynomial-container" id="polynomialContainer1">
                        <div class="term" data-term="3x^2" data-degree="2" data-coef="3">3x²</div>
                        <div class="term" data-term="5y" data-degree="1" data-coef="5">5y</div>
                        <div class="term" data-term="-2x" data-degree="1" data-coef="-2">-2x</div>
                        <div class="term" data-term="4" data-degree="0" data-coef="4">4</div>
                        <div class="term" data-term="-x^2" data-degree="2" data-coef="-1">-x²</div>
                        <div class="term" data-term="7" data-degree="0" data-coef="7">7</div>
                    </div>
                    
                    <div class="result-area" id="resultArea1">
                        <p>Результат: <span id="resultText1"></span></p>
                    </div>
                    
                    <div class="controls">
                        <button class="btn" onclick="checkPolynomial1()">
                            <i class="fas fa-check-circle"></i> Проверить
                        </button>
                        <button class="btn" onclick="resetPolynomial1()">
                            <i class="fas fa-redo"></i> Начать заново
                        </button>
                    </div>
                    
                    <div id="polynomialResult1" class="result-message"></div>
                </div>
                
                <hr>
                
                <div class="interactive-task">
                    <p>Многочлен: \\(2a^2 - 3b + 5a^2 - 7 + 2b - 4\\)</p>
                    
                    <div class="polynomial-container" id="polynomialContainer2">
                        <div class="term" data-term="2a^2" data-degree="2" data-coef="2">2a²</div>
                        <div class="term" data-term="-3b" data-degree="1" data-coef="-3">-3b</div>
                        <div class="term" data-term="5a^2" data-degree="2" data-coef="5">5a²</div>
                        <div class="term" data-term="-7" data-degree="0" data-coef="-7">-7</div>
                        <div class="term" data-term="2b" data-degree="1" data-coef="2">2b</div>
                        <div class="term" data-term="-4" data-degree="0" data-coef="-4">-4</div>
                    </div>
                    
                    <div class="result-area" id="resultArea2">
                        <p>Результат: <span id="resultText2"></span></p>
                    </div>
                    
                    <div class="controls">
                        <button class="btn" onclick="checkPolynomial2()">
                            <i class="fas fa-check-circle"></i> Проверить
                        </button>
                    </div>
                    
                    <div id="polynomialResult2" class="result-message"></div>
                </div>
            </div>
            
            <div class="content-block tip">
                <h3><i class="fas fa-lightbulb"></i> Алгоритм работы</h3>
                <ol>
                    <li>Найдите члены с одинаковыми переменными и степенями (подобные)</li>
                    <li>Сложите их коэффициенты</li>
                    <li>Расположите полученные члены в порядке убывания степени</li>
                </ol>
                <p>Для первого примера правильный ответ: \\(2x^2 + 5y - 2x + 11\\)</p>
            </div>
    ...
    // Слайд 6 - Теория: Степень многочлена
    {
    ...
    // Слайд 7 - Интерактивное задание: Определение степени
    {
        ...
        content: `
            <div class="exercise">
                ...
                <div class="degree-task">
                    <p>Для каждого многочлена выберите правильную степень:</p>
                    
                    <div class="degree-example">
                        <p><strong>Пример 1:</strong> \\(4a^3b^2 - 2ab + 5\\)</p>
                        <div class="degree-options">
                            <button class="degree-option" onclick="checkDegree(1, 2)">2</button>
                            <button class="degree-option" onclick="checkDegree(1, 3)">3</button>
                            <button class="degree-option" onclick="checkDegree(1, 5)">5</button>
                            <button class="degree-option" onclick="checkDegree(1, 0)">0</button>
                        </div>
                        <div id="degreeResult1" class="result-hint"></div>
                    </div>
                    
                    <div class="degree-example">
                        <p><strong>Пример 2:</strong> \\(3x^2y^3 + 2x^4 - y^2\\)</p>
                        <div class="degree-options">
                            <button class="degree-option" onclick="checkDegree(2, 3)">3</button>
                            <button class="degree-option" onclick="checkDegree(2, 4)">4</button>
                            <button class="degree-option" onclick="checkDegree(2, 5)">5</button>
                            <button class="degree-option" onclick="checkDegree(2, 6)">6</button>
                        </div>
                        <div id="degreeResult2" class="result-hint"></div>
                    </div>
                    
                    <div class="degree-example">
                        <p><strong>Пример 3:</strong> \\(7m^2n - 3mn^2 + 8\\)</p>
                        <div class="degree-options">
                            <button class="degree-option" onclick="checkDegree(3, 2)">2</button>
                            <button class="degree-option" onclick="checkDegree(3, 3)">3</button>
                            <button class="degree-option" onclick="checkDegree(3, 4)">4</button>
                            <button class="degree-option" onclick="checkDegree(3, 0)">0</button>
                        </div>
                        <div id="degreeResult3" class="result-hint"></div>
                    </div>
                    
                    <div class="degree-example">
                        <p><strong>Пример 4:</strong> \\(2p^5q - p^3q^3 + 4pq^4\\)</p>
                        <div class="degree-options">
                            <button class="degree-option" onclick="checkDegree(4, 5)">5</button>
                            <button class="degree-option" onclick="checkDegree(4, 6)">6</button>
                            <button class="degree-option" onclick="checkDegree(4, 8)">8</button>
                            <button class="degree-option" onclick="checkDegree(4, 9)">9</button>
                        </div>
                        <div id="degreeResult4" class="result-hint"></div>
                    </div>
                    
                    <div class="degree-example">
                        <p><strong>Пример 5:</strong> \\(10x^6 - 3x^4y^2 + 2x^2y^3 - y^5\\)</p>
                        <div class="degree-options">
                            <button class="degree-option" onclick="checkDegree(5, 5)">5</button>
                            <button class="degree-option" onclick="checkDegree(5, 6)">6</button>
                            <button class="degree-option" onclick="checkDegree(5, 7)">7</button>
                            <button class="degree-option" onclick="checkDegree(5, 8)">8</button>
                        </div>
    ...
    // Слайд 8 - Решение в тетради: Значение многочлена
    {
    ...
    // Слайд 9 - Решение в тетради: Преобразование в стандартный вид
    {
    ...
    // Слайд 10 - Решение в тетради: Подобные члены и значения
    {
                ...
                <div class="final-test-task">
                    ...
                    <div class="test-task">
                        ...
                        <div class="input-field">
                            <span>Ответ (многочлен):</span>
                            <input type="text" id="finalAnswer5" placeholder="Введите многочлен">
                        </div>
                        <div class="input-field">
                            <span>Степень:</span>
    ...
    // Слайд 14 - Дополнительные материалы: Видео
    {
...
// Переменные для задания "Приведение подобных" (Слайд 5)
let currentDraggedTerm = null;

// Переменные для задания "Определение степени" (Слайд 7)
...
// Переменные для итоговой работы (Слайд 11)
...
// Функции для задания "Приведение подобных" (Слайд 5)
function initPolynomialTasks() {
    // Инициализируем перетаскивание для членов многочлена
    document.querySelectorAll('.term').forEach(term => {
        ...
        // Для touch устройств
        term.addEventListener('touchstart', handleTermTouchStart);
        term.addEventListener('touchend', handleTermTouchEnd);
    });
    
    // Добавляем обработчики для контейнеров
    document.querySelectorAll('.polynomial-container').forEach(container => {
        container.addEventListener('dragover', handleTermDragOver);
        container.addEventListener('drop', handleTermDrop);
        
        // Для touch устройств
        container.addEventListener('touchmove', handleTermTouchMove);
        container.addEventListener('touchend', handleTermTouchDrop);
    });
}

function handleTermDragStart() {
    currentDraggedTerm = this;
    this.classList.add('dragging');
}
...
function handleTermDrop(e) {
    e.preventDefault();
    if (currentDraggedTerm && this !== currentDraggedTerm.parentElement) {
        this.appendChild(currentDraggedTerm);
        updatePolynomialResult(this.id);
    }
}

// Touch handlers для перетаскивания членов
...
function handleTermTouchDrop(e) {
    e.preventDefault();
    if (currentDraggedTerm) {
        const touch = e.changedTouches[0];
        const element = document.elementFromPoint(touch.clientX, touch.clientY);
        
        if (element && element.classList.contains('polynomial-container') && 
            element !== currentDraggedTerm.parentElement) {
            element.appendChild(currentDraggedTerm);
            updatePolynomialResult(element.id);
        }
    }
}

function updatePolynomialResult(containerId) {
    const container = document.getElementById(containerId);
    if (!container) return;
    
    const terms = Array.from(container.children);
    const resultText = combineLikeTerms(terms);
    
    const resultId = containerId.replace('Container', 'Text');
...
function combineLikeTerms(terms) {
    ...
    terms.forEach(term => {
        const degree = term.dataset.degree;
        const coef = parseFloat(term.dataset.coef);
        const termText = term.dataset.term;
        
        // Извлекаем переменную часть (без коэффициента)
        let variablePart = termText.replace(/^-?\d*\.?\d*/, '').replace(/^\+/, '');
        if (variablePart === '') variablePart = '1'; // Для констант
        
        if (!termGroups[variablePart]) {
            termGroups[variablePart] = 0;
        }
        termGroups[variablePart] += coef;
    });
    
    // Строим результат
    let result = '';
    const sortedGroups = Object.keys(termGroups).sort((a, b) => {
        // Сортируем по убыванию степени
        const degreeA = a === '1' ? 0 : (a.match(/\^(\d+)/) ? parseInt(a.match(/\^(\d+)/)[1]) : 1);
        const degreeB = b === '1' ? 0 : (b.match(/\^(\d+)/) ? parseInt(b.match(/\^(\d+)/)[1]) : 1);
        return degreeB - degreeA;
    });
    
    sortedGroups.forEach((variable, index) => {
        const coef = termGroups[variable];
        if (coef !== 0) {
            let termStr = '';
            if (coef > 0 && index > 0) termStr += '+';
            if (coef === -1 && variable !== '1') termStr += '-';
            else if (coef !== 1 || variable === '1') termStr += coef;
            
            if (variable !== '1') termStr += variable;
...
function checkPolynomial1() {
    const container = document.getElementById('polynomialContainer1');
    const terms = Array.from(container.children);
    const result = combineLikeTerms(terms);
    
    // Правильный ответ для первого многочлена: 2x² + 5y - 2x + 11
    const correctResult = '2x^2+5y-2x+11';
    const userResult = result.replace(/\s+/g, '');
    
    const resultMessage = document.getElementById('polynomialResult1');
    if (!resultMessage) return;
    ...
    if (userResult === correctResult) {
        resultMessage.classList.add('success');
        resultMessage.innerHTML = `<i class="fas fa-check-circle"></i> Верно! Многочлен приведён к стандартному виду: \\(2x^2 + 5y - 2x + 11\\)`;
    } else {
        resultMessage.classList.add('error');
        resultMessage.innerHTML = `<i class="fas fa-times-circle"></i> Неверно. Попробуйте ещё раз. Правильный ответ: \\(2x^2 + 5y - 2x + 11\\)`;
    }
}

function checkPolynomial2() {
    const container = document.getElementById('polynomialContainer2');
    const terms = Array.from(container.children);
    const result = combineLikeTerms(terms);
    
    // Правильный ответ для второго многочлена: 7a² - b - 11
    const correctResult = '7a^2-b-11';
    const userResult = result.replace(/\s+/g, '');
    
    const resultMessage = document.getElementById('polynomialResult2');
    if (!resultMessage) return;
    ...
    if (userResult === correctResult) {
        resultMessage.classList.add('success');
        resultMessage.innerHTML = `<i class="fas fa-check-circle"></i> Верно! Многочлен приведён к стандартному виду: \\(7a^2 - b - 11\\)`;
    } else {
        resultMessage.classList.add('error');
        resultMessage.innerHTML = `<i class="fas fa-times-circle"></i> Неверно. Попробуйте ещё раз. Правильный ответ: \\(7a^2 - b - 11\\)`;
    }
}

function resetPolynomial1() {
    const container = document.getElementById('polynomialContainer1');
    if (!container) return;
    
    // Возвращаем члены в исходном порядке
    const terms = ['3x^2', '5y', '-2x', '4', '-x^2', '7'];
    container.innerHTML = '';
    ...
    terms.forEach(term => {
        ...
        termElement.dataset.degree = degree;
        termElement.dataset.coef = coef;
        termElement.textContent = displayText;
        ...
        // Для touch устройств
        termElement.addEventListener('touchstart', handleTermTouchStart);
        termElement.addEventListener('touchend', handleTermTouchEnd);
...
// Функции для задания "Определение степени" (Слайд 7)
...
function checkFinalTest() {
    ...
    // Нормализуем ответ (убираем пробелы, приводим к одному формату)
    const normalizedAnswer5 = answer5.replace(/\s+/g, '');
    const normalizedCorrect5 = finalTestAnswers.answer5.replace(/\s+/g, '').toLowerCase();
    
    // Проверяем многочлен
    if (normalizedAnswer5 === normalizedCorrect5 || 
        normalizedAnswer5 === '3x^2+4x-11' || 
        normalizedAnswer5 === '3x²+4x-11') {
        document.getElementById('finalAnswer5').classList.add('correct');
        correctCount += 0.5; // Полбалла за многочлен
    } else {
    ...
    if (degree5 === finalTestAnswers.degree5) {
        ...
        correctCount += 0.5; // Полбалла за степень
    } else {
    ...
    if (resultMessage) {
        resultMessage.className = 'result-message';
        resultMessage.innerHTML = `<i class="fas fa-chart-bar"></i> Правильно решено ${correctCount.toFixed(1)} из ${totalQuestions} заданий (${percentage.toFixed(1)}%)`;
    }
...
function resetFinalTest() {
    ...
    const textFields = ['finalAnswer5', 'finalDegree5', 'finalAnswer6'];
...
function initializeSlideComponents(slideIndex) {
    switch(slideIndex) {
        case 2: // Слайд 3 - Классификация
            ...
            break;
        case 4: // Слайд 5 - Приведение подобных
            setTimeout(() => {
                initPolynomialTasks();
                initDrawingPanel();
            }, 100);
